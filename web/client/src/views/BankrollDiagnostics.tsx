    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-2 gap-6 mt-8">
        <div className="glass-panel p-6 rounded-2xl h-96 flex flex-col items-center justify-center">
           <h3 className="text-zinc-400 font-bold mb-2">Closing Line Value (CLV)</h3>
           <p className="text-sm text-zinc-500">Recharts will be mounted here shortly...</p>
        </div>
        <div className="glass-panel p-6 rounded-2xl h-96 flex flex-col items-center justify-center relative overflow-hidden">
           <h3 className="text-zinc-400 font-bold mb-2">Drawdown Gauge</h3>
           <p className="text-sm text-zinc-500 mb-8">Recharts Radial Bar mounted here...</p>
